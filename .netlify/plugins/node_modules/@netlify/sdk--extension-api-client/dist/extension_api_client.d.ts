...
export type ExtensionClientOptions = {
    ...
    netlifyTokenHeader?: "netlify-token" | "netlify-build-bot-token";
};
...
export declare class NetlifyExtensionClient<SiteConfiguration, TeamConfiguration, ConnectorConfiguration> extends NetlifyClient {
    ...
    constructor(netlifyToken: string, extension: string, { jigsawUrl, netlifyApiUrl, netlifyTokenHeader, }?: ExtensionClientOptions);
    /**
